  ...
  <div>
    ...
    <div class="container">
      <div class="user-con">
        ...
        >
          <el-button style="margin-top: 200px">Upload</el-button>
        </el-upload>
      </div>
      ...
      <div class="right-con">
        <div class="menu-con">
          <div>USER ID: {{ userInfo.id }} | {{ userInfo.surname }} {{ userInfo.name }}</div>
          <div
            class="bt"
...
import { getData, del as delData, getGPSData } from "@/api/data";
export default {
  components: {
    EDAChart,
    BVPChart,
  ...
  methods: {
    ...
    fetchGPSData() {
      this.gpsData = [];
      getGPSData(this.sessionData[this.curViewSessionDataIndex].id).then(
        (response) => {
